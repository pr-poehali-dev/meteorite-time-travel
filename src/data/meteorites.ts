...
export const METEORITES: Meteorite[] = [
  ...
  },
  {
    ...
    emoji: '🌋',
    color: '#5C3D2E',
    description: 'Величайший взрыв в атмосфере в истории наблюдений. Взорвался над сибирской тайгой, повалив лес на площади 2150 км². Фрагментов на поверхности найдено не было — тело полностью испарилось.',
    composition: [
    ...
    facts: [
      'Взрыв мощностью 10–15 Мт (1000 ядерных бомб)',
      'Лес повален на 2150 кв. км',
      'Взрывная волна дважды обошла Землю',
    ],
    difficulty: 'intermediate',
  },
  {
    ...
    emoji: '🗿',
    color: '#7A6652',
    description: 'Крупнейший метеорит, найденный в США. Покрыт глубокими кавернами — следами тысячелетней эрозии. Коренные народы Орегона почитали его как священный объект задолго до открытия европейцами.',
    composition: [
      { element: 'Железо', percent: 91, color: '#8B4513' },
      { element: 'Никель', percent: 7.6, color: '#A9A9A9' },
      { element: 'Галлий', percent: 0.9, color: '#C0C0FF' },
      { element: 'Прочее', percent: 0.5, color: '#9B8B6B' },
    ],
    facts: [
      'Священный объект народа клакамас',
      'Глубокие каверны — следы дождя за тысячи лет',
      'Хранится в Музее естественной истории Нью-Йорка',
    ],
    difficulty: 'beginner',
  },
  {
    ...
    emoji: '🧬',
    color: '#3D2B1F',
    description: 'Один из самых богатых органикой метеоритов. Содержит более 70 аминокислот, из которых только 19 встречаются на Земле. Хранит ключи к разгадке происхождения жизни во Вселенной.',
    composition: [
      { element: 'Силикаты', percent: 68, color: '#8B7355' },
      { element: 'Углерод', percent: 12, color: '#444' },
      { element: 'Органика', percent: 8, color: '#5C8A3C' },
      { element: 'Прочее', percent: 12, color: '#9B8B6B' },
    ],
    facts: [
      'Более 70 видов аминокислот внеземного происхождения',
      'Возраст некоторых зёрен — 7 млрд лет',
      'Содержит сахара и нуклеобазы ДНК',
    ],
    difficulty: 'expert',
  },
  {
    ...
    emoji: '🔩',
    color: '#8C8C8C',
    description: 'Красивейший железный метеорит с выраженными видманштеттеновыми узорами — кристаллическими полосами никелистого железа. Поле рассеяния растянулось на 275 × 100 км по пустыне Намиб.',
    composition: [
      { element: 'Железо', percent: 91.5, color: '#8B4513' },
      { element: 'Никель', percent: 7.9, color: '#A9A9A9' },
      { element: 'Кобальт', percent: 0.5, color: '#4169E1' },
      { element: 'Прочее', percent: 0.1, color: '#9B8B6B' },
    ],
    facts: [
      'Поле рассеяния 275 × 100 км',
      'Видманштеттены формировались миллионы лет',
  ...
  },
  {
    ...
    emoji: '🪐',
    color: '#2C1810',
    description: 'Самый богатый водой марсианский метеорит. Содержит в 10 раз больше воды, чем другие марсианские образцы. Рассказывает о влажном прошлом Красной планеты.',
    composition: [
      { element: 'Базальт', percent: 70, color: '#5C5C5C' },
      { element: 'Оксиды железа', percent: 20, color: '#8B3A2F' },
      { element: 'Карбонаты', percent: 7, color: '#D4A78B' },
      { element: 'Прочее', percent: 3, color: '#9B8B6B' },
    ],
    facts: [
      'В 10 раз больше воды, чем другие марс. метеориты',
      'Возраст 4.4 млрд лет — ранняя кора Марса',
      'Самый тёмный из марсианских метеоритов',
    ],
    difficulty: 'expert',
  },
  {
    ...
    emoji: '🧊',
    color: '#4A6080',
    description: 'Второй по массе метеорит Земли. Эскимосы использовали его железо для изготовления орудий труда тысячи лет. Адмирал Пири вывез главные фрагменты в США в 1897 году.',
    composition: [
      { element: 'Железо', percent: 92.3, color: '#8B4513' },
      { element: 'Никель', percent: 7.5, color: '#A9A9A9' },
      { element: 'Прочее', percent: 0.2, color: '#9B8B6B' },
    ],
    facts: [
      'Эскимосы добывали из него железо 1000 лет',
      'Три главных фрагмента: Анигото, Женщина, Собака',
      'Хранится в Музее естественной истории Нью-Йорка',
    ],
    difficulty: 'beginner',
  },
  {
    ...
    emoji: '💎',
    color: '#1A1A2E',
    description: 'Один из самых примитивных метеоритов, когда-либо найденных. Упал на замёрзшее озеро в Юконе и был быстро собран, сохранив уникальный состав. Возможно, родом из пояса астероидов D-типа.',
    composition: [
    ...
    facts: [
      'Собран через несколько дней после падения',
      'Содержит межзвёздные алмазы',
      'Один из самых тёмных метеоритов (альбедо 0.04)',
    ],
    difficulty: 'expert',
  },
];
